jQuery("#simulation")
  .on("click", ".s-747fc3a1-cb07-47ee-a2aa-dc2801a9ac1a .click", function(event, data) {
    ...
    if(jFirer.is("#s-Triangle")) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/24d2c4b7-3edb-4ae0-8026-89cf56c269d1",
                    "transition": {
                      "type": "slideandfade",
                      "duration": 700
                    }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-flat_Button_darkTheme")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-747fc3a1-cb07-47ee-a2aa-dc2801a9ac1a #s-flat_Button_darkTheme > .backgroundLayer": {
                      "attributes": {
                        "background-color": "#F2F2F2"
                      }
                    }
                  },{
                    "#s-747fc3a1-cb07-47ee-a2aa-dc2801a9ac1a #s-flat_Button_darkTheme": {
                      "attributes-ie": {
                ...
                },
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/1e02236d-b496-4c66-bfe8-0b76ad31c20b",
                    "transition": {
                      "type": "slideandfade",
                      "duration": 700
                    }
